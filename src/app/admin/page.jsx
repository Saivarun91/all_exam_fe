...
export default function AdminPage() {
  ...
  const dashboardCards = [
    ...
    { name: "Practice Tests Manager", path: "/admin/home/practice-tests-manager", icon: ClipboardList, color: "from-teal-500 to-teal-600", bgColor: "bg-teal-50", borderColor: "border-teal-200" },
    { name: "Official Details Manager", path: "/admin/home/official-details-manager", icon: BookOpen, color: "from-fuchsia-500 to-fuchsia-600", bgColor: "bg-fuchsia-50", borderColor: "border-fuchsia-200" },
