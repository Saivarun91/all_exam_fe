...
export default function ExamDetailsManager() {
  ...
  // ✅ Correct way to sync SEO fields when selectedCourse changes
  useEffect(() => {
    if (selectedCourse) {
      setMetaTitle(selectedCourse.meta_title || "");
      setMetaKeywords(selectedCourse.meta_keywords || "");
              ...
              <Tabs defaultValue="basic" className="w-full">
                ...
                <TabsContent value="seo" className="space-y-4">
                  <div className="mt-6 pt-6 border-t">
                    <h3 className="text-lg font-semibold mb-4 text-[#0C1A35]">
                      SEO Meta Information (This Exam Only)
                    </h3>
