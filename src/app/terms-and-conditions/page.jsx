...
import BackButton from "./BackButton"; // import client-side back button

// Fetch terms & conditions data from API
async function fetchTerms() {
  try {
    const API_BASE_URL = process.env.NEXT_PUBLIC_API_BASE_URL || "http://127.0.0.1:8000";
    const res = await fetch(`${API_BASE_URL}/api/settings/terms-of-service/`, { next: { revalidate: 60 } });
...
export const metadata = {
  title: "Terms & Conditions - AllExamQuestions | User Agreement & Terms of Service",
  description:
    "Review AllExamQuestions Terms & Conditions. Understand your rights, responsibilities, and the terms of service when using our exam preparation platform and practice tests.",
  keywords:
    "terms and conditions, terms of service, user agreement, legal terms, AllExamQuestions terms, exam platform terms, service agreement",
  alternates: {
...
export default async function TermsAndConditionsPage() {
  const { content, error } = await fetchTerms();
