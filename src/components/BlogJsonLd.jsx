...
/**
 * Blog JSON-LD Structured Data Component (Server Component)
 * Renders Schema.org BlogPosting JSON-LD script tag
 */

export default function BlogJsonLd({ blog, currentUrl }) {
  if (!blog) return null;
  ...
  const blogJsonLd = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": currentUrl || `https://allexamquestions.com/blog/${blog.slug || ""}`,
    },
  };
