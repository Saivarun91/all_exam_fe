...
//   try {
//     const res = await fetch(`${API_BASE_URL}/api/home/blog-posts/slug/${slug}/`, { next: { revalidate: 60 } });
//     const data = await res.json();
//     if (data.success && data.data) {
...
//             </div>
//           )}
//           <h1 className="text-4xl md:text-5xl font-bold text-[#0C1A35] mb-6 leading-tight">{blog.title}</h1>
//           <div className="flex flex-wrap items-center gap-6 text-sm text-[#0C1A35]/60 mb-8">
//             <div className="flex items-center gap-2">
//               <Calendar className="w-4 h-4" />
//               <span>
...
//             <div className="relative w-full aspect-[16/9] mb-8 rounded-lg overflow-hidden bg-gray-100">
//               <img
//                 src={blog.image_url ? getOptimizedImageUrl(blog.image_url, 1200, 675) : 'https://via.placeholder.com/800x400/1A73E8/ffffff?text=Blog+Post'}
//                 alt={blog.title}
//                 width={1200}
//                 height={675}
//                 className="w-full h-full object-contain"
